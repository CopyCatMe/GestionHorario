...
<div class="max-w-7xl mx-auto py-10 sm:px-6 lg:px-8">
    ...
    <div
        class="p-6 lg:p-8 bg-white dark:bg-gray-800 dark:bg-gradient-to-bl dark:from-gray-700/50 dark:via-transparent border-b border-gray-200 dark:border-gray-700 lg:rounded-lg">
        ...
        @else
            <div
                class="overflow-x-auto bg-white dark:bg-gray-800 rounded-lg shadow-md ring-1 ring-gray-200 dark:ring-gray-700">
